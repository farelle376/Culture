...
<div class="row">
                ...
                <div class="card mb-12">
                  <div class="card-header">
                    ...
                    <a href="{{route('langues.create') }}"><button class="btn btn-primary" style="margin-left:850px">Nouveau</button></a>
                </div>
                  <!-- /.card-header -->
                  <div class="card-body">
              ...
              <div class="footer-content">
                <div class="footer-column">
                    <h3>BeninCulture</h3>
                    <p>Plateforme de partage de la culture béninoise</p>
                </div>
                <div class="footer-column">
                    <h3>Contact</h3>
                    <ul class="footer-links">
                        <li><i class="fas fa-envelope"></i> contact@beninculture.bj</li>
                        <li><i class="fas fa-phone"></i> +229 12 34 56 78</li>
...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="nav-links">
            <li><a href="{{ route('dashboard') }}"><i class="fas fa-home"></i> <span class="nav-text">Tableau de Bord</span></a></li>
            <li><a href="{{ route('utilisateurs.index') }}"><i class="fas fa-users"></i> <span class="nav-text">Utilisateurs</span></a></li>
            ...
            <li><a href="{{ route('register') }}"><i class="fas fa-user-plus"></i> <span class="nav-text">Créer un utilisateur</span></a></li>
        </ul>
    </div>
